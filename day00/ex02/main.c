...
/*
	...
	printf("price for the art \'%s\' is %d\n", "Überflieger", searchPrice(arts, n, "Überflieger"));
	printf("price for the art \'%s\' is %d\n", "\" 5X 0 \"", searchPrice(arts, n, "\" 5X 0 \""));
	printf("price for the art \'%s\' is %d\n", "No Title", searchPrice(arts, n, "No Title"));
	printf("price for the art \'%s\' is %d\n", "!", searchPrice(arts, n, "!"));
	printf("price for the art \'%s\' is %d\n", "…..a páty jezdec je Strach (The Fifth Rider is Fear) (Poster for 1964 Czechoslovakian film directed by Zbynek Brynych)", searchPrice(arts, n, "…..a páty jezdec je Strach (The Fifth Rider is Fear) (Poster for 1964 Czechoslovakian film directed by Zbynek Brynych)"));
	printf("price for the art \'%s\' is %d\n", "! no pasaran! 7 de Noviembre Madrid", searchPrice(arts, n, "! no pasaran! 7 de Noviembre Madrid"));
	printf("price for the art \'%s\' is %d\n", "Title", searchPrice(arts, n, "Title"));
	printf("price for the art \'%s\' is %d\n", "5", searchPrice(arts, n, " 5"));
	printf("price for the art \'%s\' is %d\n", "wat", searchPrice(arts, n, "w a t"));
	printf("price for the art \'%s\' is %d\n", " Title 5 X", searchPrice(arts, n, " Title 5 X "));
*/
	return (0);
}
